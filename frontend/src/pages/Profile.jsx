...
const Profile = () => {
  const { authUser, isUpdatingProfile,updateError } = useSelector((state) => state.auth);
            ...
            <div className="flex flex-col items-center gap-4">
              <div className="relative">
                <img
                  ...
                  className="w-32 h-32 rounded-full object-cover object-top bordr-4 border-gray-200"
                />
                <label
